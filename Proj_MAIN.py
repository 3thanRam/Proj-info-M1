...
def main(T,n1,n2,vo,l,Numb_Dimensions,BoundsCond,D,File_path_name=None):
    ...
    """
    global dt,Dist_min,DIM_Numb,Numb_part,Numb_antipart,Ntot,V0,L,BOUNDARY_COND,TRACKING,SYSTEM,ALL_TIME,Vflipinfo,INTERCHECK,COUNTFCT,BOUNDARY_FCT,Linf,sd
...
if __name__ == "__main__":
    ...
    REPR,DIM,Bounds,Vdistr=2,0,2,2
